...
/**
 * "Continue with Google" button. Opens the ProfilleAI web login (Google + email)
 * and syncs the session back into the extension once the user signs in.
 */
export const GoogleSignInButton: React.FC<GoogleSignInButtonProps> = ({ onAuthSync, hint }) => {
  ...
  return (
    <>
      ...
      >
        ...
        {webSyncing ? 'Waiting for sign-in…' : 'Continue with Google'}
      </button>
      {webSyncing ? (
