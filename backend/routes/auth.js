...
// Implementation lives in services/linkedinOAuth.js so /api/profiles routes
// can reuse the same helper for the "prefill profile from LinkedIn" flow.
// `fetchLinkedInProfile` is imported at the top of this file.
