...
export const Logo = styled.div`
  ...
  gap: 8px;
  cursor: pointer;
  svg { font-size: 26px; color: #a78bfa; }
`;
...
export const MockTag = styled.span`
  ...
  align-items: center;
  gap: 4px;
  background: ${props => props.$bg || 'rgba(167,139,250,0.08)'};
...
export const ChoiceCard = styled.div`
  ...
  &:hover {
    ...
    box-shadow: 0 12px 36px rgba(167,139,250,0.18);
  }
`;

export const ChoiceCardVisual = styled.div`
  height: 160px;
  background: ${props => props.$bg || 'linear-gradient(135deg, #a78bfa 0%, #7c3aed 100%)'};
  display: flex;
  align-items: center;
  justify-content: center;
  position: relative;
