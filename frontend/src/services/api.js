...
export const profileAPI = {
  ...
  // Import a full profile from a LinkedIn URL (requires ENRICHLAYER_API_KEY
  // on the server). Returns the same shape as uploadResume so it can flow
  ...
  linkedinOAuthPrefill: (code, redirectUri) =>
    api.post('/profiles/linkedin-oauth-prefill', { code, redirectUri }),
